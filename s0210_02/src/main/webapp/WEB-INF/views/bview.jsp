...
<meta charset="UTF-8">
  ...
  <script>
  	const deleteBtn = (bno) => {
  		if(confirm(bno+" | Would you like to delete your post?")){
  			alert("Completed");
//   			게시글 삭제시 원래 get 으로 보내면 안되고 post로 보내야함(보안상 위험), 지금은 연습중이라 get으로 함
...
<%--     <a href="/board/bdelete?bno=${bdto.bno}"><div class="list">삭제</div></a> --%>
