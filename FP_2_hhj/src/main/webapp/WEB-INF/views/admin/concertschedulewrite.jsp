                    ...
                    >
                      ...
                      <tbody>
						<tr>
							...
							<select name="SaleConcertDto.saleConcertNo">
							    <c:forEach var="saleConcert" items="${list}">
							        <option value="${saleConcert.saleConcertNo}">${saleConcert.saleConcertDesc}</option>
							    </c:forEach>
							</select>
							</td>
						</tr>
						<tr>
						    <th>스케줄 날짜</th>
						    <td>
						        <input type="date" name="scheduleDate" class="title" style="width:200px; height:30px;">
						    </td>
						</tr>
						<tr>
						    <th>스케줄 시작 시간</th>
						    <td>
						        <input type="time" name="scheduleStartTime" style="width:200px; height:30px;">
						    </td>
						</tr>
                      </tbody>
                      <tfoot>
