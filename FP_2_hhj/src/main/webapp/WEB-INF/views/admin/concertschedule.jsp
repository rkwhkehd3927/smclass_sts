        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">콘서트 스케줄리스트</h5>
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <c:if test="${not empty list}">
						 <c:forEach items="${list}" var="csdto">
					       <tr>
					         <td>${csdto.scheduleNo}</td>
					         <td><a href="/concertscheduleInfo?schedule_no=${csdto.scheduleNo}">${csdto.saleConcertDto.saleConcertDesc}</a></td>
					         <td>${csdto.scheduleDate}</td>
					         <td>${csdto.scheduleStartTime}</td>
					       </tr>
					     </c:forEach>
                         </c:if>
                         <c:if test="${empty list }">
                           <tr>
                      	     <td colspan="5" style="text-align: center;">스케줄 정보가 없습니다.</td>
                           </tr>
                         </c:if>
                      </tbody>
                      <tfoot>
                    ...
                    <button type="button" class="register-button" onclick="location.href='/concertschedulewrite'">등록</button>
                  </div>
                </div>
              </div>
            </div>
