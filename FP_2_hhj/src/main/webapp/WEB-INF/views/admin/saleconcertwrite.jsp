        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">콘서트 티켓등록</h5>
                    ...
                    >
                      ...
                      <tbody>
						<tr>
							...
							<select name="concertDto.concertNo">
							    <c:forEach var="concert" items="${list}">
							        <option value="${concert.concertNo}">${concert.concertName}</option>
							    </c:forEach>
							</select>
							</td>
						</tr>
					    ...
					    <tr>
					        <th>티켓 타입</th>
					        <td>
					            <input type="radio" name="ticketType" value="offline"> 오프라인&nbsp;&nbsp;
					            <input type="radio" name="ticketType" value="online" checked> 온라인
					        </td>
					    </tr>
					    ...
					    <tr>
					        ...
					        <td>
					            <input type="number" name="concertPrice"
					                   style="width:500px; height:30px;" step="1000" >
					        </td>
					    </tr>
					        <tr>
					        <th>상품 설명</th>
					        <td>
					            <textarea name="saleConcertDesc" style="width:500px; height:100px;"></textarea>
					        </td>
					    </tr>
						<tr>
							<th>판매 썸네일 이미지</th>
