...
<html dir="ltr" lang="en">
  <head>
    ...
    <script>
		const deleteBtn = () =>{
			if(confirm("${cdto.concertNo}번 콘서트 정보를 삭제하시겠습니까?")){
				$.ajax({
					url:"/concertdelete",
					type:"post",	
					data:{"concert_no":"${cdto.concertNo}"},
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                  	<form action="/concertwrite" name="writeFrm" method="post" enctype="multipart/form-data">
                    <table
                      id="zero_config"
                    ...
                    >
                      ...
                      <tbody>
                        <input type="hidden" name="concertNo" value="${cdto.concertNo}">
						<tr>
							<th>아티스트명</th>
							<td>
						...
						<tr>
							<th>콘서트명</th>
							<td><input type="text" name="concertName" class="title" value="${cdto.concertName}" style="width:500px; height:30px;"></td>
						</tr>
						<tr>
						    <th>콘서트 시작시간</th>
						    <td>
						        <input type="datetime-local" name="concertStartDatetime" class="title" 
						               style="width:500px; height:30px;" 
						               value="${fn:substring(cdto.concertStartDatetime, 0, 16)}">
						    </td>
						</tr>
						<tr>
						    <th>콘서트 종료시간</th>
						    <td>
						        <input type="datetime-local" name="concertEndDatetime" class="title" 
						               style="width:500px; height:30px;" 
						               value="${fn:substring(cdto.concertEndDatetime, 0, 16)}">
						    </td>
						</tr>
						<tr>
							<th>장소</th>
							<td><input type="text" name="location" class="title" value="${cdto.location}" style="width:500px; height:30px;"></td>
						</tr>
					    <tr>
					        <th>관람 가능 최소연령</th>
					        <td>
					            <input type="number" name="concertAvailAge" class="title" style="width:500px; height:30px;" 
					                   value="${cdto.concertAvailAge}">
					        </td>
					    </tr>
					    <tr>
					        <th>콘서트 지속시간</th>
					        <td>
					            <input type="number" name="concertDuration" class="title" style="width:500px; height:30px;" 
					                   value="${cdto.concertDuration}">
					        </td>
					    </tr>
                      </tbody>
                      <tfoot>
					...
					<button type="button" onclick="location.href='/concert'" class="register-button">취소</button>
                  </div>
                </div>
              </div>
            </div>
