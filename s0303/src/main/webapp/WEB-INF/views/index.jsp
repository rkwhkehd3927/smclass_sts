...
<%-- 		<div>logoutChk: ${logoutChk}</div> --%>
		...
		<script>
		    $(document).ready(function() {
		        $('#openPopup').click(function(event) {
		            ...
		            window.open('/ticketShop/seatPopUp', 'popup', 'width=1100,height=680');
		        });
		...
		<ul>
			<c:if test="${session_id == null }">
				...
				<li><a href="/ticketShop/concertReservation">concertReservation</a></li>
				<li><a href="/ticketShop/marketplace">marketplace</a></li>
