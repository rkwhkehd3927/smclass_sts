                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <c:if test="${not empty list}">
						 <c:forEach items="${list}" var="scdto">
					       <tr>
					         <td>${scdto.saleConcertNo}</td>
					         <td>${scdto.concertDto.concertName}</td>
					         <td><a href="/saleconcertInfo?saleconcert_no=${scdto.saleConcertNo}">${scdto.saleConcertDesc}</a></td>
					         <td>${scdto.ticketType}</td>
					         <td>${scdto.concertPrice}</td>
					       </tr>
					     </c:forEach>
                         </c:if>
                         <c:if test="${empty list }">
                           <tr>
                      	     <td colspan="5" style="text-align: center;">콘서트티켓 정보가 없습니다.</td>
                           </tr>
                         </c:if>
                      </tbody>
                      <tfoot>
                    ...
                    <button type="button" class="register-button" onclick="location.href='/saleconcertwrite'">등록</button>
                  </div>
                </div>
              </div>
            </div>
