            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-chart-bar"></i
                  ><span class="hide-menu">콘서트 티켓관리</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="/concertschedule"
                  aria-expanded="false"
                  ><i class="mdi mdi-chart-bar"></i
                  ><span class="hide-menu">콘서트 스케줄관리</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">콘서트 리스트</h5>
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <c:if test="${not empty list}">
						 <c:forEach items="${list}" var="cdto">
					       <tr>
					         <td>${cdto.concertNo}</td>
					         <td>${cdto.artistDto.artist_group_name}</td>
					         <td><a href="/concertInfo?concert_no=${cdto.concertNo}">${cdto.concertName}</a></td>
					         <td>${cdto.location}</td>
					         <td>${cdto.concertDuration}</td>
					       </tr>
					     </c:forEach>
                         </c:if>
                         <c:if test="${empty list }">
                           <tr>
                      	     <td colspan="5" style="text-align: center;">콘서트 정보가 없습니다.</td>
                           </tr>
                         </c:if>
                      </tbody>
                      <tfoot>
                    ...
                    <button type="button" class="register-button" onclick="location.href='/concertwrite'">등록</button>
                  </div>
                </div>
              </div>
            </div>
